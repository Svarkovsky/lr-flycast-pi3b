	...
	ifneq (,$(findstring rpi4,$(platform)))
		...
		ifneq (,$(findstring rpi4_64,$(platform)))
			...
			ifneq (,$(findstring rpi3_64,$(platform)))
				...
				ARM_FLOAT_ABI_HARD = 0
				CPUFLAGS += -DTARGET_LINUX_ARMv8 -frename-registers
				CFLAGS += -march=armv8-a+crc -mtune=cortex-a53 -mtune=cortex-a53 $(CPUFLAGS)
				CXXFLAGS += -march=armv8-a+crc -mtune=cortex-a53 -mtune=cortex-a53 $(CPUFLAGS)
				ASFLAGS += $(CFLAGS) -c -frename-registers -fno-strict-aliasing -ffast-math -ftree-vectorize
				WITH_DYNAREC=arm64
			else
...
# Generic AArch64 Cortex-A53 OpenGL ES 2.0 target
	...
	CFLAGS += -mtune=cortex-a53 -mtune=cortex-a53 $(CPUFLAGS)
	CXXFLAGS += -mtune=cortex-a53 -mtune=cortex-a53 $(CPUFLAGS)
	ASFLAGS += $(CFLAGS) -c -frename-registers -fno-strict-aliasing -ffast-math -ftree-vectorize
	PLATFORM_EXT := unix
	WITH_DYNAREC=arm64
	HAVE_GENERIC_JIT = 0
...
# --- custom Pi3B (match working original: dynamic libstdc++, tuned cortex-a53) ---
CFLAGS   += -Ofast -mtune=cortex-a53 -mfpu=neon-fp-armv8 -mfloat-abi=hard -marm -DTARGET_NO_STENCIL -DLOW_END -DTARGET_LINUX_ARMELv7 -DFORCE_FAST_RENDER -I/home/user/test/vc/include --sysroot=/home/user/test/sysroot -fno-plt -fno-semantic-interposition -fipa-pta -funroll-loops --param max-unroll-times=4 -ftree-vectorize -fomit-frame-pointer
CXXFLAGS += -Ofast -mtune=cortex-a53 -mfpu=neon-fp-armv8 -mfloat-abi=hard -marm -DTARGET_NO_STENCIL -DLOW_END -DTARGET_LINUX_ARMELv7 -DFORCE_FAST_RENDER -I/home/user/test/vc/include --sysroot=/home/user/test/sysroot -fno-plt -fno-semantic-interposition -fipa-pta -funroll-loops --param max-unroll-times=4 -ftree-vectorize -fomit-frame-pointer
LIBS     += -lm
LDFLAGS  += --sysroot=/home/user/test/sysroot -L/home/user/test/sysroot/usr/lib/arm-linux-gnueabihf -L/home/user/test/sysroot/lib/arm-linux-gnueabihf -nodefaultlibs -Wl,--fix-v4bx
LDFLAGS_END += /home/user/test/flycast-src/libc_compat.o /home/user/test/flycast-src/libc_compat2.o -lc -lm -lrt -lpthread -ldl /home/user/test/sysroot/usr/lib/arm-linux-gnueabihf/libstdc++.so.6 /home/user/test/sysroot/usr/lib/arm-linux-gnueabihf/libgcc_s.so.1 /home/user/test/sysroot/usr/lib/arm-linux-gnueabihf/libgomp.so.1
...
%.o: %.cpp
	$(CXX) $(INCFLAGS) $(CFLAGS) $(MFLAGS) $(CXXFLAGS) -c $< -o $@
	
%.o: %.c
	$(CC) $(INCFLAGS) $(CFLAGS) $(MFLAGS) -c $< -o $@
